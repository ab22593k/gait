...
mod tests {
    ...
    fn test_normalize_path() {
        ...
        assert_eq!(filter.normalize_path("src/main.rs"), "src/main.rs");
        assert_eq!(filter.normalize_path("./src/main.rs"), "src/main.rs");
        assert_eq!(filter.normalize_path("src/./main.rs"), "src/main.rs");

        // Test path traversal removal.
        assert_eq!(filter.normalize_path("../src/main.rs"), "src/main.rs");
        assert_eq!(filter.normalize_path("src/../lib/utils.rs"), "lib/utils.rs");
    }
    ...
    fn test_filter_repository_content() {
        ...
        fs::create_dir_all(src_path.join("docs")).unwrap();
        fs::write(src_path.join("src").join("main.rs"), "fn main() {}").unwrap();
        fs::write(src_path.join("docs").join("README.md"), "# Docs").unwrap();
        fs::write(src_path.join("LICENSE"), "MIT License").unwrap();
