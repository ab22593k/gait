...
use crate::models::cached_repo::CachedRepository;
use crate::models::repo_config::RepositoryConfiguration;
use crate::models::wire_operation::WireOperation;
...
impl CacheManager {
    ...
    fn get_cache_path(&self, key: &str) -> Result<String, String> {
...
mod tests {
    ...
    fn test_cache_manager_creation() {
        ...
        assert_eq!(cache_manager.cache.lock().unwrap().len(), 0);
    }
    ...
    fn test_get_or_schedule_fetch_new_repo() {
        ...
        let key = CacheKeyGenerator::generate_key(&config);
        let cache = cache_manager.cache.lock().unwrap();
